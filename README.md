...
O **Finança Fácil** é uma aplicação web desenvolvida como Projeto Integrador do curso de [Nome do Curso] da UNIVESP — Polo [Nome do Polo].
...
| Q2 | Definição do problema e Plano de Ação | ⏳ Pendente |
